...
export default class chatWootClient {
  declare config: any;
  declare mobile_name: string;
  declare mobile_number: string;
  declare sender: { pushname: string; id: string };
  declare account_id: string;
  declare inbox_id: string;
  declare api: any;
  ...
  async findConversation(contact: any) {
    try {
      ...
      return data.data.payload.find((e: any) => e.meta.sender.id == contact.id && e.status != 'resolved');
    } catch (e) {
      console.log(e);
      return null;
    }
  ...
  async createConversation(contact: any, source_id: string) {
