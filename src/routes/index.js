...
routes.post(
  ...
  verifyToken,
  statusConnection,
  DeviceController.sendMentioned
);
...
routes.post(
  ...
  verifyToken,
  statusConnection,
  DeviceController.changePrivacyGroup
);
routes.post(
...
routes.post(
  ...
  verifyToken,
  statusConnection,
  SessionController.killServiceWorker
);
routes.post(
  '/api/:session/restart-service',
  verifyToken,
  statusConnection,
  SessionController.restartService
);
